...
const ProfilePage1: React.FC = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      const attendeeId = '66f841e6516c67a34056bbb2'; // Replace this with the actual organizer ID from the route or state
  ...
  const handleEditProfile = () => {
    router.push('/profile1/edit-profile'); // Navigate to the Edit Profile page
  };

  const handleBack = () => {
    router.push('/'); // Go back to events dashboard
  };
